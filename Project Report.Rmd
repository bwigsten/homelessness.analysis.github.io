...
total_data = total_data %>%
  rename(coc_number = co_c_number, 
         ...
         total_sheltered = sheltered_total_homeless, 
         total_unsheltered = unsheltered_homeless, 
         people_in_families = homeless_people_in_families, 
  ...
  mutate(total_homeless = as.numeric(total_homeless), 
         total_sheltered = as.numeric(total_sheltered), 
         total_unsheltered = as.numeric(total_unsheltered), 
         people_in_families = as.numeric(people_in_families), 
