...
### Total Homelessness Over Time Graph
```{r}
...
## Total Homelessness Over Time Stratified by Shelter Status
```{r}
...
## Chronic Homelessness Over Time Stratified by Shelter Status
```{r}
...
## Veteran Homelessness Over Time by Shelter Status
```{r}
